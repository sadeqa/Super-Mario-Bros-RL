...
def get_args():
    ...
    parser.add_argument('--num-mini-batch', type=int, default=12,
    ...
    parser.add_argument('--num-env-steps', type=int, default=10e6,
                        help='number of environment steps to train (default: 10e4)')
    parser.add_argument('--env-name', default='SuperMarioBrosNoFrameskip-1-1-v0',
                        help='environment to train on (default: PongNoFrameskip-v4)')
    parser.add_argument('--log-dir', default='./log_dir/',
                        help='directory to save agent logs (default: ./log_dir/)')
